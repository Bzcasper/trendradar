...
export const TrendVisualizationWidget = () => {
  return (
    <div className="w-full h-full min-h-[400px] flex justify-center items-center overflow-hidden">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400" className="w-full h-full">
        ...
        <rect width="800" height="400" fill="url(#bgGradient)" rx="13" ry="13" />
